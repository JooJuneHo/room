...
public class UserControllerTest {
    ...
    void signup() {
        ...
        ResponseEntity<ResponseDto<String>> responseEntity = userController.signup(dto,
            bindingResult);
    ...
    void login() {
        ...
        // when
        ResponseEntity<ResponseDto<String>> responseEntity = userController.login(dto, res);
    ...
    void getUserProfile_Success() throws Exception {
        ...
        given(userService.getUserProfile(userDetailsImpl.getUser().getId())).willReturn(
            userResponseDto);
    ...
    void updateUser_Success() throws Exception {
        ...
        given(userService.updateUser(any(UserDetailsImpl.class),
            any(UserRequestDto.class))).willReturn(userResponseDto);
    ...
    void updatePassword_Success() throws Exception {
        ...
        doNothing().when(userService)
            .updatePassword(any(UserDetailsImpl.class), any(PasswordUpdateRequestDto.class));
